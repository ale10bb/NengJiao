Public Function Main()
    ...
    newAttachment.Bookmarks("C0项目编号1").Range.Text = codeStr
    newAttachment.Bookmarks("C0项目编号2").Range.Text = codeStr
    ...
    Call tempRange.Find.Execute(FindText:="B.3 漏洞详细", Forward:=True)
